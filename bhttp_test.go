...
func TestTruncation(t *testing.T) {
	...
	// This request (known-length encoding) has valid truncation since it has no content or trailers and truncates both
	...
	// This request (known-length encoding) has valid truncation since last two zero bytes when completely removed - corresponding to content and a trailer section - shouldn't alter the semantic of the request
	...
	// This request (known-length encoding) has valid truncation since it has content (4 bytes of 'b','o','d','y') but truncated trailers
	...
	// This request (known-length encoding) has invalid truncation since it truncates the content but not the trailers
	...
	// This request (indeterminate-length encoding) has valid truncation since last two zero bytes when completely removed - corresponding to content and a trailer section - shouldn't alter the semantic of the request
	encodedRequest, err = hex.DecodeString("")
	require.Nil(t, err)
	binaryRequest, err = UnmarshalBinaryRequest(encodedRequest)
	require.Nil(t, err)
	require.Equal(t, int(binaryRequest.ContentLength), 0)

	// This request (indeterminate-length encoding) has invalid truncation since it truncates zero byte of headers section
	encodedRequest, err = hex.DecodeString("")
	require.Nil(t, err)
	_, err = UnmarshalBinaryRequest(encodedRequest)
	require.NotNil(t, err)
}
